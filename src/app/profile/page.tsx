          ...
          <div style={{ background: '#EF444418', border: '1px solid #EF444466', borderRadius: 12, padding: '16px 20px', marginBottom: 24, display: 'flex', alignItems: 'flex-start', gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ color: 'var(--text-muted)', fontSize: 13 }}>
                {isEmployer
                  ? <>Your employer subscription has expired. Please contact us at <a href="mailto:logthelift@gmail.com" onClick={e => { e.preventDefault(); window.location.href = 'mailto:logthelift@gmail.com'; }} style={{ color: 'var(--accent)', cursor: 'pointer' }}>logthelift@gmail.com</a> to restore access to your team members and programs.</>
