export default function PatientsIcon({ size = 56, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <rect x="11" y="13" width="34" height="34" rx="3" className="liftlog-icon-clipboard" stroke="#1EDBA8" strokeWidth="2" />
      <rect x="20" y="9" width="16" height="7" rx="3" className="liftlog-icon-clipboard" stroke="#1EDBA8" strokeWidth="2" />
